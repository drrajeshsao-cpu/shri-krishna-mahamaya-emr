const CACHE_NAME = 'mahamaya-emr-v5.10-20260814-r22';
const CORE_ASSETS = [
  ...
  './therapeutics-intelligence-master-v1.json', './antibiotic-intelligence-v1.json', './therapeutics-intelligence-engine.js',
