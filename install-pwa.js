/* Mahamaya Clinic EMR V5.52 — installability controller only.
  ...
  function ensureHelp(){
    ...
    el.innerHTML=`<div style="width:min(520px,100%);background:#fff;border-radius:18px;padding:20px;box-shadow:0 18px 60px rgba(0,0,0,.28);border:1px solid #cbdde3">
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:10px">
        ...
        <div><h2 id="pwaInstallHelpTitle" style="margin:0;color:#0b6f78;font-size:20px">Install Mahamaya EMR</h2><div style="font-size:12px;color:#4d6570">V5.52 • Standalone clinical app</div></div>
      </div>
